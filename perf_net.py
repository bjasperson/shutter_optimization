...
class Network9(Network):  
    def __init__(self, input_data, kernel_size = 3): #was 512               
        ...
        self.conv2 = nn.Conv2d(in_channels = out_ch_conv1, out_channels = out_ch_conv1, kernel_size = k1, padding=p1, stride=s1, bias=True) 
        self.conv3 = nn.Conv2d(in_channels = out_ch_conv1, out_channels = out_ch_conv1, kernel_size = k1, padding=p1, stride=s1, bias=True) 
        self.batch_norm1c = nn.BatchNorm2d(out_ch_conv1)
